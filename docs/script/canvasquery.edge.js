...
(function() {
  ...
  cq.Layer.prototype = {
    ...
    drawAtlasFrame: function(atlas, frame, x, y, r, s, alignX, alignY) {
      ...
      this.drawRegion(
        atlas.image,
        frame.region, 
        -frame.width * this.alignX + frame.offset[0] + frame.region[2] * this.alignX, 
        -frame.height * this.alignY + frame.offset[1] + frame.region[3] * this.alignY
      );
